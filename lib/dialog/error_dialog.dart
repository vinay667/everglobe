...
class ErrorDialog extends StatelessWidget {
 ...
 ErrorDialog(this.message,this.context);
  @override
        ...
        children: <Widget>[
          ...
          GestureDetector(
            ...
            child: Container(
                width: 100,
                height: 45,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: MyColor.noInternetColor),
