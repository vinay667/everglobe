              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      TextWidget('REGISTER HERE', Colors.black87, 13),
    ...
    try {
      ...
      if(list.length==0)
      ...
      else
        {
          ...
          _saveUserDetail(fetchResponse['Response']['UserDetails'][0]['vchUserID'], fetchResponse['Response']['UserDetails'][0]['vchUserType']);
...
*/
  ...
  _saveUserDetail(String email,String access_token)
  async {
